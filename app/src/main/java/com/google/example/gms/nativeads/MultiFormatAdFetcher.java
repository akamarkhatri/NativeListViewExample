...
//            AdRequest.Builder.addTestDevice("E9586B10E8D9E56473B5A5D3E18EED99")
//            mAdLoader.loadAd(new PublisherAdRequest.Builder().addTestDevice("E9586B10E8D9E56473B5A5D3E18EED99").build());
            mAdLoader.loadAd(AdUtil.getPublisherAdRequest());
        }
    }
}
