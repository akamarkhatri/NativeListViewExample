...
public class MainActivity extends ActionBarActivity {
     ...
     */
    private static final String DFP_SIMPLE_CUSTOM_TEMPLATE_AD_UNIT_ID =            "/6499/example/custom_template/simple";

    /**
     * A DFP ad unit configured to both of the above in rotation
     */
    private static final String DFP_MULTIFORMAT_AD_UNIT_ID =        "/6499/example/native-multiformat";

    /**
     * Index where a DFP content ad should be placed.
     */
    private static final int DFP_CONTENT_AD_INDEX = 0;//6;

    /**
     * Index where a DFP app install ad should be placed.
     */
    private static final int DFP_APP_INSTALL_AD_INDEX = 1;//12;

    /**
     * Index where a DFP custom template ad should be placed
     */
    private static final int DFP_CUSTOM_TEMPLATE_AD_INDEX = 2;//18;

    /**
     * Index where a DFP custom template ad should be placed
     */
    private static final int DFP_MULTIFORMAT_AD_INDEX = 3;//24;
...
*/
           ...
           /* rowItems.add(DFP_CONTENT_AD_INDEX,
                    new ContentAdPlacement(new ContentAdFetcher(AdUtil.TOP_LISTING)));
           rowItems.add(DFP_APP_INSTALL_AD_INDEX,
                    new AppInstallAdPlacement(new AppInstallAdFetcher(AdUtil.TOP_LISTING_BOLLYWOOD)));*/
           ...
           rowItems.add(DFP_CUSTOM_TEMPLATE_AD_INDEX,
            ...
            rowItems.add(5,
                    new AppInstallAdPlacement(new AppInstallAdFetcher("/28928716/DB_APP_Native_Top_ListingPage")));
